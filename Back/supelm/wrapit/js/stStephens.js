...
var $author$project$StStephens$LandingP = function (a) {
	return {$: 'LandingP', a: a};
};
var $author$project$StStephens$Loading = {$: 'Loading'};
var $author$project$StStephens$Model = F6(
	function (someName, items, navbarState, page, currentEntry, jsonDebug) {
		return {currentEntry: currentEntry, items: items, jsonDebug: jsonDebug, navbarState: navbarState, page: page, someName: someName};
	});
var $author$project$StStephens$NavbarMsg = function (a) {
	return {$: 'NavbarMsg', a: a};
};
var $author$project$StStephens$GotApiResult = function (a) {
...
var $author$project$StStephens$Entry = F3(
	function (name, asset, moment) {
		return {asset: asset, moment: moment, name: name};
	});
...
var $author$project$StStephens$getDateTime = function (aString) {
	var result = A2($elm$core$String$endsWith, 'Z', aString) ? $rtfeldman$elm_iso8601_date_strings$Iso8601$toTime(aString) : $rtfeldman$elm_iso8601_date_strings$Iso8601$toTime(
		A2(
			$elm$core$String$left,
			19,
			A3($elm$core$String$replace, ' ', 'T', aString)) + 'Z');
	if (result.$ === 'Ok') {
		var posixVal = result.a;
		return posixVal;
	} else {
		var deadEnd = result.a;
		return $elm$time$Time$millisToPosix(0);
	}
};
var $author$project$StStephens$decodeEntry = function (stringList) {
	if (((stringList.b && stringList.b.b) && stringList.b.b.b) && (!stringList.b.b.b.b)) {
		var x = stringList.a;
		...
		return $elm$core$Result$Ok(
			A3(
				$author$project$StStephens$Entry,
				x,
				y,
				$author$project$StStephens$getDateTime(z)));
	} else {
		return $elm$core$Result$Err(
			'Looking for a list of 3 strings exactly: ' + A3(
				$elm$core$List$foldr,
				F2(
					function (s, accum) {
						return (accum === '') ? s : (s + (', ' + accum));
					}),
				'',
				stringList));
	}
...
var $author$project$StStephens$fromResult = function (result) {
	if (result.$ === 'Ok') {
		var a = result.a;
...
var $author$project$StStephens$decodeStringArray = A2(
	$elm$json$Json$Decode$andThen,
	A2($elm$core$Basics$composeL, $author$project$StStephens$fromResult, $author$project$StStephens$decodeEntry),
...
var $author$project$StStephens$decodeList = function (code) {
	switch (code) {
		case 'ok':
			return A2(
				...
				$elm$json$Json$Decode$dict(
					$elm$json$Json$Decode$list($author$project$StStephens$decodeStringArray)));
		case 'err':
			return A2(
				$elm$json$Json$Decode$andThen,
				function (err) {
					return $elm$json$Json$Decode$fail('api err: ' + err);
				},
				A2($elm$json$Json$Decode$field, 'reason', $elm$json$Json$Decode$string));
		default:
			return $elm$json$Json$Decode$fail('Unknown situation: ' + code);
	}
};
var $author$project$StStephens$decodeEntries = A2(
	$elm$json$Json$Decode$andThen,
	$author$project$StStephens$decodeList,
...
var $author$project$StStephens$getItemList = $elm$http$Http$post(
	{
		body: A2($elm$http$Http$stringBody, 'application/x-www-form-urlencoded', 'a=1'),
		expect: A2($elm$http$Http$expectJson, $author$project$StStephens$GotApiResult, $author$project$StStephens$decodeEntries),
		url: 'http://chodov:7001/apistub'
	});
var $author$project$StStephens$initEntries = {english: _List_Nil, ipc: _List_Nil, math: _List_Nil, pe: _List_Nil, phonics: _List_Nil};
...
var $author$project$StStephens$init = function (aParam) {
	var _v0 = $rundis$elm_bootstrap$Bootstrap$Navbar$initialState($author$project$StStephens$NavbarMsg);
	var initState = _v0.a;
	var command = _v0.b;
	return _Utils_Tuple2(
		A6(
			$author$project$StStephens$Model,
			aParam,
			$author$project$StStephens$initEntries,
			initState,
			$author$project$StStephens$LandingP($author$project$StStephens$Loading),
			$elm$core$Maybe$Nothing,
			''),
		$author$project$StStephens$getItemList);
};
...
var $author$project$StStephens$subscriptions = function (model) {
	return A2($rundis$elm_bootstrap$Bootstrap$Navbar$subscriptions, model.navbarState, $author$project$StStephens$NavbarMsg);
};
var $author$project$StStephens$FailureP = {$: 'FailureP'};
var $author$project$StStephens$TimeP = {$: 'TimeP'};
var $author$project$StStephens$TopicP = {$: 'TopicP'};
var $author$project$StStephens$ViewVideoP = {$: 'ViewVideoP'};
var $author$project$StStephens$AllEntries = F5(
	function (english, ipc, phonics, pe, math) {
		return {english: english, ipc: ipc, math: math, pe: pe, phonics: phonics};
	});
var $author$project$StStephens$getListOfEntries = function (aValue) {
	if (aValue.$ === 'Just') {
		var array = aValue.a;
		return array;
	} else {
...
var $author$project$StStephens$apiContentToAllEntries = function (aDict) {
	var phonics = $author$project$StStephens$getListOfEntries(
		A2($elm$core$Dict$get, 'phonics', aDict));
	var math = $author$project$StStephens$getListOfEntries(
		A2($elm$core$Dict$get, 'math', aDict));
	var ipc = $author$project$StStephens$getListOfEntries(
		A2($elm$core$Dict$get, 'ipc', aDict));
	var english = $author$project$StStephens$getListOfEntries(
		A2($elm$core$Dict$get, 'english', aDict));
	return A5($author$project$StStephens$AllEntries, english, ipc, phonics, _List_Nil, math);
};
...
var $author$project$StStephens$describeError = F3(
	function (error, label, model) {
		switch (error.$) {
			case 'BadUrl':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{jsonDebug: label + ' badUrl', page: $author$project$StStephens$FailureP}),
					$elm$core$Platform$Cmd$none);
			case 'Timeout':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{jsonDebug: label + ' timeout', page: $author$project$StStephens$FailureP}),
					$elm$core$Platform$Cmd$none);
			case 'NetworkError':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{jsonDebug: label + ' netErr', page: $author$project$StStephens$FailureP}),
					$elm$core$Platform$Cmd$none);
			case 'BadStatus':
				var number = error.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{jsonDebug: label + ' bad code', page: $author$project$StStephens$FailureP}),
					$elm$core$Platform$Cmd$none);
			default:
				var bodyMsg = error.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{jsonDebug: label + (' bad body: ' + bodyMsg), page: $author$project$StStephens$FailureP}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$StStephens$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NavbarMsg':
				var state = msg.a;
			...
			case 'LandingAct':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							page: $author$project$StStephens$LandingP($author$project$StStephens$Loading)
						}),
					$elm$core$Platform$Cmd$none);
			case 'M1Act':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{page: $author$project$StStephens$TimeP}),
					$elm$core$Platform$Cmd$none);
			case 'M2Act':
				var newModel = model;
				return _Utils_Tuple2(
					_Utils_update(
						newModel,
						{page: $author$project$StStephens$TopicP}),
					$elm$core$Platform$Cmd$none);
			case 'ViewVideoAct':
				var entry = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							currentEntry: $elm$core$Maybe$Just(entry),
							page: $author$project$StStephens$ViewVideoP
						}),
					$elm$core$Platform$Cmd$none);
			case 'GotApiResult':
				var results = msg.a;
				if (results.$ === 'Ok') {
					var entries = results.a;
					var oldItems = model.items;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								items: $author$project$StStephens$apiContentToAllEntries(entries),
								page: $author$project$StStephens$TopicP
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var error = results.a;
					return A3($author$project$StStephens$describeError, error, 'HttpErr', model);
				}
			default:
				var tResult = msg.a;
				if (tResult.$ === 'Ok') {
					var stringList = tResult.a;
					var flatString = A3(
						$elm$core$List$foldr,
						$elm$core$Basics$append,
						'',
						A3($elm$core$List$foldr, $elm$core$List$append, _List_Nil, stringList));
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{jsonDebug: flatString, page: $author$project$StStephens$FailureP}),
						$elm$core$Platform$Cmd$none);
				} else {
					var error = tResult.a;
					return A3($author$project$StStephens$describeError, error, 'TestErr', model);
				}
		}
	});
var $author$project$StStephens$Failure = {$: 'Failure'};
var $elm$html$Html$div = _VirtualDom_node('div');
var $author$project$StStephens$countEntry = function (anEntry) {
	if (anEntry.$ === 'Just') {
		var x = anEntry.a;
...
var $author$project$StStephens$countEntries = function (maybeEntries) {
	if (maybeEntries.$ === 'Ok') {
		var entries = maybeEntries.a;
		var totalLength = (($author$project$StStephens$countEntry(
			A2($elm$core$Dict$get, 'english', entries)) + $author$project$StStephens$countEntry(
			A2($elm$core$Dict$get, 'ipc', entries))) + $author$project$StStephens$countEntry(
			A2($elm$core$Dict$get, 'phonics', entries))) + $author$project$StStephens$countEntry(
			A2($elm$core$Dict$get, 'math', entries));
		return $elm$core$String$fromInt(totalLength);
	} else {
		return '0 (err.)';
	}
};
...
var $author$project$StStephens$landingBody = F2(
	function (model, pageState) {
		switch (pageState.$) {
			case 'Loading':
				return A2(
					$elm$html$Html$div,
			...
			case 'Failure':
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Initialisation failed : ' + model.jsonDebug)
						]));
			default:
				var content = pageState.a;
				if (content.$ === 'Ok') {
					var values = content.a;
					return A2(
						$elm$html$Html$div,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text(
								'success, ' + ($author$project$StStephens$countEntries(content) + ' entries.'))
							]));
				} else {
					var error = content.a;
					return A2(
...
var $author$project$StStephens$timeBody = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var $author$project$StStephens$ViewVideoAct = function (a) {
	return {$: 'ViewVideoAct', a: a};
};
...
var $author$project$StStephens$cdnUrlPrefix = 'http://chodov/video';
var $author$project$StStephens$getImagePath = function (entry) {
	return $author$project$StStephens$cdnUrlPrefix + ('/poster_' + (entry.asset + '.png'));
};
...
var $author$project$StStephens$monthToNbr = function (aMonth) {
	switch (aMonth.$) {
		case 'Jan':
			return 1;
		case 'Feb':
...
var $author$project$StStephens$showMoment = function (aDT) {
	return $elm$core$String$fromInt(
		A2($elm$time$Time$toYear, $elm$time$Time$utc, aDT) - 2000) + ('.' + ($elm$core$String$fromInt(
		$author$project$StStephens$monthToNbr(
			A2($elm$time$Time$toMonth, $elm$time$Time$utc, aDT))) + ('.' + $elm$core$String$fromInt(
		A2($elm$time$Time$toDay, $elm$time$Time$utc, aDT)))));
};
...
var $author$project$StStephens$formatEntry = function (entry) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$StStephens$ViewVideoAct(entry))
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('entryImg'),
												A2($elm$html$Html$Attributes$attribute, 'alt', entry.name),
												A2(
												$elm$html$Html$Attributes$attribute,
												'src',
												$author$project$StStephens$getImagePath(entry))
											]),
										_List_Nil)
									]))
							]))
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('entryCol')
							]))
					]),
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								entry.name + (', ' + $author$project$StStephens$showMoment(entry.moment)))
							]))
					]))
			]));
};
...
var $author$project$StStephens$format3Entries = function (entries) {
	return A2(
		$rundis$elm_bootstrap$Bootstrap$Grid$row,
		_List_Nil,
		A2(
			...
			function (entry) {
				return A2(
					...
					_List_fromArray(
						[
							$author$project$StStephens$formatEntry(entry)
						]));
			},
			entries));
};
...
var $author$project$StStephens$splitAt = F2(
	function (n, xs) {
		return _Utils_Tuple2(
			A2($elm$core$List$take, n, xs),
			A2($elm$core$List$drop, n, xs));
	});
var $author$project$StStephens$groupByN = F2(
	function (length, list) {
		var _v0 = A2($author$project$StStephens$splitAt, length, list);
		var first = _v0.a;
		var second = _v0.b;
		return _Utils_eq(second, _List_Nil) ? _List_fromArray(
			[first]) : A2(
			$elm$core$List$cons,
			first,
			A2($author$project$StStephens$groupByN, length, second));
	});
var $author$project$StStephens$layoutEntries = function (entries) {
	var subGroups = A2($author$project$StStephens$groupByN, 4, entries);
	return A2($elm$core$List$map, $author$project$StStephens$format3Entries, subGroups);
};
var $author$project$StStephens$formatTopic = F2(
	function (label, entries) {
		return _List_fromArray(
			[
				...
				_List_Nil,
				$author$project$StStephens$layoutEntries(entries))
			]);
	});
var $author$project$StStephens$topicBody = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_Utils_ap(
			A2($author$project$StStephens$formatTopic, 'English', model.items.english),
			_Utils_ap(
				A2($author$project$StStephens$formatTopic, 'IPC', model.items.ipc),
				_Utils_ap(
					A2($author$project$StStephens$formatTopic, 'Math', model.items.math),
					_Utils_ap(
						A2($author$project$StStephens$formatTopic, 'Phonics', model.items.phonics),
						A2($author$project$StStephens$formatTopic, 'PE', model.items.pe))))));
};
var $author$project$StStephens$getVideoPath = function (entry) {
	return $author$project$StStephens$cdnUrlPrefix + ('/' + (entry.asset + '.mp4'));
};
var $elm$html$Html$source = _VirtualDom_node('source');
var $elm$html$Html$video = _VirtualDom_node('video');
var $author$project$StStephens$videoDisplay = function (model) {
	var _v0 = model.currentEntry;
	if (_v0.$ === 'Just') {
		var entry = _v0.a;
		return A2(
			$elm$html$Html$div,
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$attribute,
									'src',
									$author$project$StStephens$getVideoPath(entry))
								]),
							_List_Nil)
						]))
				]));
...
var $author$project$StStephens$bodySection = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				switch (_v0.$) {
					case 'LandingP':
						var pageContext = _v0.a;
						return A2($author$project$StStephens$landingBody, model, pageContext);
					case 'TimeP':
						return $author$project$StStephens$timeBody(model);
					case 'TopicP':
						return $author$project$StStephens$topicBody(model);
					case 'ViewVideoP':
						return $author$project$StStephens$videoDisplay(model);
					default:
						return A2($author$project$StStephens$landingBody, model, $author$project$StStephens$Failure);
				}
			}()
			]));
};
var $elm$html$Html$header = _VirtualDom_node('header');
var $author$project$StStephens$LandingAct = {$: 'LandingAct'};
var $author$project$StStephens$M1Act = {$: 'M1Act'};
var $author$project$StStephens$M2Act = {$: 'M2Act'};
...
var $author$project$StStephens$navBarSection = function (model) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('#'),
							$elm$html$Html$Events$onClick($author$project$StStephens$M1Act)
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Time')
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('#'),
							$elm$html$Html$Events$onClick($author$project$StStephens$M2Act)
						]),
					_List_fromArray(
						[
			...
			A3(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href('#'),
						$elm$html$Html$Events$onClick($author$project$StStephens$LandingAct)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Myriam')
					]),
				$rundis$elm_bootstrap$Bootstrap$Navbar$config($author$project$StStephens$NavbarMsg))));
};
var $author$project$StStephens$headSection = function (model) {
	return A2(
		$elm$html$Html$header,
		_List_Nil,
		_List_fromArray(
			[
				$author$project$StStephens$navBarSection(model)
			]));
};
var $author$project$StStephens$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$author$project$StStephens$headSection(model),
				$author$project$StStephens$bodySection(model)
			]));
};
var $author$project$StStephens$main = $elm$browser$Browser$element(
	{init: $author$project$StStephens$init, subscriptions: $author$project$StStephens$subscriptions, update: $author$project$StStephens$update, view: $author$project$StStephens$view});
_Platform_export({'StStephens':{'init':$author$project$StStephens$main($elm$json$Json$Decode$string)(0)}});}(this));