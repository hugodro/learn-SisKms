...
def getOptions():
  return [
      ...
      , { "id": 2, "label": "Try Layout Test", "function": test_2 }
      , { "id": 3, "label": "Elm Masonry Example", "function": test_3 }
    ]
...
def test_2(request):
  page= "wrapit/testGeneric.html"
  pageCtxt= { "pageTitle": "Layout Package", "moduleName": "TryLayoutLib", "elmCode": "tryLaoyoutLib.js", "flags": ""}
  return page, pageCtxt

def test_3(request):
  page= "wrapit/testGeneric.html"
  pageCtxt= { "pageTitle": "Masonry Example", "moduleName": "Main", "elmCode": "masonryExample.js", "flags": { "width": "window.innerWidth", "height": "window.innerHeight"}}
  return page, pageCtxt


#--- SIS assets:
globSisItems= { "result": "ok"
     , "items": {
       "english": [
